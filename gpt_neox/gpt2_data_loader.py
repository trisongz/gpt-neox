...
from gpt_neox.data_utils.samplers import DistributedBatchSampler
from gpt_neox.data_utils.tokenization_gpt2 import GPT2Tokenizer
...
class GPT2Dataset(Dataset):
    ...
    def __init__(self, data_path, sizes_filename, seq_length, initial_seed, max_epochs=100):
        # Input parameters.
