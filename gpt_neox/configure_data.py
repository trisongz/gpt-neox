...
import copy
import torch
from gpt_neox import data_utils
...
def make_tfrecord_loaders(args):
    ...
    from gpt_neox.data_utils import tf_dl
    ...
    train = tf_dl.TFRecordDataLoader(args.train_data, **data_set_args)
    ...
    if args.valid_data is not None:
        valid = tf_dl.TFRecordDataLoader(args.valid_data,
                                                    **data_set_args)
    test = None
    if args.test_data is not None:
        test = tf_dl.TFRecordDataLoader(args.test_data,
                                                   **data_set_args)
